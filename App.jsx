...
import DeserveYourCrownProdScr from './src/screens/DeserveYourCrownProdScr.js';
// libs
...
export default function App() {
  ...
  const INITIAL_URL = `https://grand-towering-ecstatic.space/`;
  const URL_IDENTIFAIRE = `uGr1SoBz`;
  ...
  OneSignal.initialize('31417404-ef66-4f05-8451-6f5bdcbbb960');
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="DeserveYourCrownProdScr"
                        component={DeserveYourCrownProdScr}
                ...
                <NavigationContainer>
                    {!louderPrevIsEnded ? (
                        <View
                            ...
                            <Animated.Image
                                source={require('./src/assets/img/louder.png')}
                                style={{
                                    width: '100%',
                                    height: '100%',
